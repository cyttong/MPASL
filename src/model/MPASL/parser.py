...
def parse_args():
	...
	parser.add_argument('--dataset', type=str, default='SynlethDB', help='which dataset to use')
	parser.add_argument('--aggregator', type=str, default='sum', help='which aggregator to use')
	parser.add_argument('--n_epochs', type=int, default=20, help='the number of epochs')
	parser.add_argument('--neighbor_sample_size', type=int, default=8, help='the number of neighbors to be sampled')
	parser.add_argument('--p_hop', type=int, default=1, help='mix hop')
	parser.add_argument('--genem_agg_hop', type=int, default=0, help='mix hop')
	parser.add_argument('--n_memory', type=int, default=16, help='size of ripple set for each hop')
	parser.add_argument('--dim', type=int, default=8, help='dimension of genem and entity embeddings')
	parser.add_argument('--h_hop', type=int, default=3, help='number of iterations when computing entity representation')#3
	...
	parser.add_argument('--update_genen_emb', type=str, default='transform_matrix', help='transform_matrix')
	...
	parser.add_argument('--save_record_genem_list', type=bool, default=False, help='number of iterations when computing entity representation')
	parser.add_argument('--show_topk_mode', type=bool, default=False, help='save default model')
	parser.add_argument('--genem_neighbor_rate', type=list, default=0, help='genem_neighbor_rate')
	parser.add_argument('--save_model_name', type=str, default="model1", help='save default model')
	parser.add_argument('--new_load_data', type=bool, default=True, help='size of training dataset')
	parser.add_argument('--log_name', type=str, default='', help='save default log')
	parser.add_argument('--emb_update_mode', type=str, default='agg_attention',
						help='how to update genen at the end of each hop')
	...
	parser.add_argument('--Genem_orient', type=int, default=1, help='size of training dataset')
	parser.add_argument('--Genem_orient_rela', type=int, default=1, help='size of training dataset')
	parser.add_argument('--Genem_orient_kg_eh', type=int, default=1, help='size of training dataset')
	...
	parser.add_argument('--att_type', type=str, default='ur', help='att type')
	parser.add_argument('--agg', type=str, default=' ', help='att type')
