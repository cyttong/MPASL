...
def parameter_env(args):
    if args.ablation == 'all':
        args.SW = 1
        args.Genem_orient = 1
        args.Genem_orient_rela = 1
        args.Genem_orient_kg_eh = 1
        args.PS_O_ft = 1
        args.wide_deep = 1
        args.PS_only = 0
        args.HO_only = 0
    ...
    args.SW = (args.SW == 1)
    args.Genem_orient = (args.Genem_orient == 1)
    args.Genem_orient_rela = (args.Genem_orient_rela == 1)
    args.Genem_orient_kg_eh = (args.Genem_orient_kg_eh == 1)
    args.PS_O_ft = (args.PS_O_ft == 1)
    args.wide_deep = (args.wide_deep == 1)
    args.PS_only = (args.PS_only == 1)
    args.HO_only = (args.HO_only == 1)

    print('args.ablation = ', args.ablation, 'args.SW = ', args.SW, 'args.Genem_orient = ', args.Genem_orient,  'args.Genem_orient_rela = ', \
           args.Genem_orient_rela, 'args.Genem_orient_kg_eh = ', args.Genem_orient_kg_eh ,  'args.PS_O_ft = ', args.PS_O_ft,\
